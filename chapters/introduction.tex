...
\section{Background and objectives of the thesis}
    ...
    to a solvent at neutral pH, a random coil (a sequence of amino acid residues  % proper conditions are not met to a solvent at neutral pH? Weird formulation
    ...
    Alzheimer's, but also in diagnosing those diseases.  % [reference needed]
...
\section{Structure of the thesis}
    ...
    Let me describe the global view of the thesis itself.  % Let me? Weird formulation. -> Let's
    ...
    \begin{itemize}
        ...
        to the extent possible, state-of-the-art deep learning architectures.  % to the extent possible? Weird formulation
    \end{itemize}
