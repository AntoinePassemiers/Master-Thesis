\section{Direct Coupling Analysis}
    ...
    \subsection{Potts model} \label{potts}
        ...
        The core idea in Direct Coupling Analysis (\index{DCA}) is to disentangle direct
    ...
    \subsection{Pseudo-Likelihood Maximization}
        ...
        \index{plmDCA}~\cite{EKEBERG2014341} addresses the problem of estimating the partition function by maximizing the pseudo-loglikelihood instead of the loglikelihood.
    ...
    \subsection{Gaussian Direct Coupling Analysis}
        ...
        An alternative method is to use \index{GaussDCA}~\cite{10.1371/journal.pone.0092721}, which does
        ...
        Similarly to \index{PSICOV}~\cite{doi:10.1093/bioinformatics/btr638}, evolutionary couplings are detected by keeping track of direct interations
