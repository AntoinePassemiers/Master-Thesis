...
{\LARGE  MEMO-F-524 - Master thesis:
 \vspace*{2cm}
 \linebreak[4] Towards Generative Adversarial Networks \vspace*{.2cm}  \linebreak[4]  for Protein Contact Prediction
 \vspace*{.2cm}  \linebreak[4] using Low-level Sequence Alignment Features}
